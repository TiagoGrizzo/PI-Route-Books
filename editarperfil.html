...
<body>
    ...
    <button id="btn-trocar-foto" class="btn-trocar-foto">
          ...
          <div class="div-perfil">
            ...
            <div class="orientacao-perfil">
                  <div class="campos-info">          
                    ...
                    <div class="perfil-info">
                      <label>Cidade</label>
                      <input type="text" class="input-perfil" value="Jaú-SP"  />
                    </div>
                     <div class="perfil-info">
                      <label>Estado</label>
                      <input type="text" class="input-perfil" value="São Paulo"  />
                    </div>
                     <div class="perfil-info">
                      <label>País</label>
                      <input type="text" class="input-perfil" value="Brasil"  />
                    </div>
                  </div>
            </div>      
